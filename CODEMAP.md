...
生成: 2026-09-15 13:38 JST / `python3 tools/gen_codemap.py`
...
**`js/analysis.js`** 2060行/~33,180tok ⛔ 関数121個 — 公開 `window.trendDisplayData`
　L1 データトレンドタブ（パフォーマンス最適化版） / L25 パフォーマンス: キャッシュ管理 / L51 データ列の設定 / L147 位置フィルター / L173 日付イベント情報 / L201 日付フィルター関連 / L293 フィルターパネル / L383 日付選択モーダル / L425 機種フィルター / L441 列表示・グラフ設定 / L479 メインデータ読み込み（3段階キャッシュ） / L586 Stage 1: 生データ収集 / L644 Stage 2: 集計 / L751 フィルター・ソート …他12件
